      ...
      <div class="modal-body">
        <form action="../options_Calificacion_producto-Cliente/update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            <div class="row" style="widht: 50%;margin-bottom: 10px">
              <div class="col" style=" display:flex; flex-direction: column; align-items: center;">
                <label for="formGroupExampleInput">Calificacion</label>
                <input type="number" class="form-control shadow-none" id="numeroCalificacion" name="numeroCalificacion" step="0.01">
              </div>
            </div>
            <div class="row" style="widht: 50%;margin-bottom: 10px">
              <div class="col" style=" display:flex; flex-direction: column; align-items: center;">
                <label for="formGroupExampleInput" style="margin-buttom: 5px">Comentario</label>
            ...
            <div class="row">
              <div class="col" style="display:flex; justify-content: center; gap: 40px; ">
                ...
                <button type="submit" class="btn btn-primary btn-ms"  onclick="return Validar_Editar()">Guardar</button>
              </div>
            </div>
        </form>
      </div>
