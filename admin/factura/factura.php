...
<body>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal" data-bs-id="<?= $row['idFactura'] ?>">
                                        <i class="fa-solid fa-pen"></i>
                                    </button>
                                </td>
                                <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"
                                        data-bs-id="<?= $row['idFactura'] ?>"><i class="fa-solid fa-trash"></i></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
    ...
    <?php include '../options_factura/modaldelete.php'; ?>
    <script>
        ...
        editamodal.addEventListener('shown.bs.modal', event => {
            ...
            let url = "../options_factura/getFactura.php"
