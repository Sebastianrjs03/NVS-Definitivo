...
$sql = $con->prepare("SELECT * FROM estadoenvio");
$sql->execute();
    ...
    <div class="sidebar">
        ...
        <main class="main-content1">
            ...
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    <?php include '../options_estadoenvio/examplemodal.php'; ?>
                    <?php foreach ($resultado as $row) { ?>
                        <tr>
                            <th scope="row"><?php echo $row['idEstadoEnvio']; ?></th>
                            <td><?php echo $row['estadoEnvio']; ?></td>

                            <td>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id="<?= $row['idEstadoEnvio']?>"><i class="fa-solid fa-pen"></i></button>
                            </td>
                            <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="<?= $row['idEstadoEnvio'] ?>"><i class="fa-solid fa-trash"></i></button></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
            ...
            <section>
                ...
                <?php include '../options_estadoenvio/modalInsert.php'; ?>


            </section>
    </div>

    <?php include '../options_estadoenvio/modaldelete.php'; ?>
    <script>
        ...
        editamodal.addEventListener('shown.bs.modal', event => {
            ...
            let inputMarca = editamodal.querySelector('.modal-body #estadoenvio')
            let estadoMarca = editamodal.querySelector('.modal-body #estadoe')

            let url = "../options_estadoenvio/getestadoenvio.php"
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    inputId.value = data.idEstadoEnvio
                    inputMarca.value = data.idEstadoEnvio
                    estadoMarca.value = data.estadoEnvio
