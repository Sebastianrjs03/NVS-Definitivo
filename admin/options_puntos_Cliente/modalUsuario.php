  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Editar Puntos Cliente</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="../options_puntos_Cliente/update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            <div class="row" style="margin-bottom: 20px; margin-left: 5px;">
              <div class="col" style=" display:flex; flex-direction: column; align-items: center;">
                ...
                <input type="number" class="form-control shadow-none" id="puntosTotales" name="puntosTotales" required>
              </div>
            </div>
            <div class="row">
