...
$sql = $con->prepare("SELECT * FROM puntoscliente");
$sql->execute();
...
<body>
    ...
    <div class="sidebar">
        ...
        <main class="main-content1">
            <div class="filter">
                <input type="text" placeholder="ID Puntos Cliente">
                ...
                <?php include 'options_puntos_Cliente/modalUsuario.php'; ?>
                    <?php foreach ($resultado as $row) { ?>
                        <tr style="text-align: center">
                            ...
                            <td><?= $row['totalPuntos']; ?></td>
                            <td>
                                <button type="button"
                                    class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id="<?= $row['idPuntosCliente']?>">
                                    <i class="fa-solid fa-pen"></i>
                                </button>
                            </td>
                            <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="<?= $row['idPuntosCliente']?>"><i class="fa-solid fa-trash"></i></button></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
        ...
        editamodal.addEventListener('shown.bs.modal', event => {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    inputid.value = data.idPuntosCliente
                    inputtotalPuntos.value = data.totalPuntos
