                    ...
                    <nav class="menu">
                        <ul class="ul-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <a
                                        href="../calificaciones_cliente_producto/calificacioalificacion_producto-Cliente.php">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal" data-bs-id="<?= $row['idCliente'] ?>">
                                        <i class="fa-solid fa-pen"></i>
                                    </button>
                                </td>
                                <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"
                                        data-bs-id="<?= $row['idCliente'] ?>"><i class="fa-solid fa-trash"></i></button></td>
                            </tr>
                        <?php } ?>
