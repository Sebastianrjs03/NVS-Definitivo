...
$sql_Usuario = $con->prepare("SELECT * FROM usuario");
$sql_Usuario->execute();
$resultado_Usuario = $sql_Usuario->fetchAll(PDO::FETCH_ASSOC);
    ...
    <div class="sidebar">
        ...
        <div class="table-responsive">   
            <table class="table table-striped table-dark">
                ...
                <tbody>
                <?php include '../options_soporte/modalUsuario.php'; ?>
                    <?php foreach ($resultado as $row) { ?>
                        <tr>
                            ...
                            <td>
                                <button type="button"
                                    class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id="<?= $row['idCliente']?>">
                                    <i class="fa-solid fa-pen"></i>
                                </button>
                            </td>
                            <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="<?= $row['idCliente']?>"><i class="fa-solid fa-trash"></i></button></td>
                        </tr>
                    <?php } ?>
            ...
            <section>
                ...
                <?php include '../options_soporte/modalinsert.php'; ?>
            </section>
    </div>

    <?php include '../options_soporte/modaldelete.php'; ?>
    <script>
        ...
        editamodal.addEventListener('shown.bs.modal', event => {
            ...
            let textareapqrs = editamodal.querySelector('.modal-body #pqrs')

            let url = "../options_soporte/getusuario.php"
