...
$sql = $con->prepare("SELECT * FROM desarrollador");
$sql->execute();
...
<body>
    <div class="container1">
        ...
        <main class="main-content1">
            ...
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    <?php include '../options_desarrollador/examplemodal.php'; ?>
                    <?php foreach ($resultado as $row) { ?>
                        <tr>
                            <th scope="row"><?php echo $row['idDesarrollador']; ?></th>
                            <td><?php echo $row['estadoDesarrolador']; ?></td>

                            <td>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id="<?= $row['idDesarrollador'] ?>"><i class="fa-solid fa-pen"></i></button>
                            </td>
                            <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="<?= $row['idDesarrollador'] ?>"><i class="fa-solid fa-trash"></i></button></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
            ...
            <section>
                <button type="button"
                    ...
                    <i class="fa-solid fa-plus"></i> Nuevo Desarrolador
                </button>
                <?php include '../options_desarrollador/modalInsert.php'; ?>


            </section>
    </div>

    <?php include '../options_desarrollador/modaldelete.php'; ?>
    <script>
    ...
    editamodal.addEventListener('shown.bs.modal', event => {
        ...
        let idDesarrollador = editamodal.querySelector('.modal-body #id')
        let inputId = editamodal.querySelector('.modal-body #idDesarrollador')
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                idDesarrollador.value = data.idDesarrollador
                inputId.value = data.idDesarrollador
                inputEstado.value = data.estadoDesarrolador
