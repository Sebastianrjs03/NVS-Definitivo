...
$sql = $con->prepare("SELECT * FROM generojuego");
$sql->execute();
    ...
    <div class="container1">
        ...
        <main class="main-content1">
            <div class="filter">
                ...
                <input type="text" placeholder="descripcion genero">
            ...
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    <?php include '../options_genero/examplemodal.php'; ?>
                    <?php foreach ($resultado as $row) { ?>
                        <tr>
                            <th scope="row"><?php echo $row['idGeneroJuego']; ?></th>
                            <td><?php echo $row['estadoGeneroJuego']; ?></td>

                            <td>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id="<?= $row['idGeneroJuego'] ?>"><i class="fa-solid fa-pen"></i></button>
                            </td>
                            <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="<?= $row['idGeneroJuego'] ?>"><i class="fa-solid fa-trash"></i></button></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
            ...
            <section>
                <button type="button"
                    ...
                    <i class="fa-solid fa-plus"></i> Nueva Genero
                </button>
                <?php include '../options_genero/modalInsert.php'; ?>


            </section>
    </div>

    <?php include '../options_genero/modaldelete.php'; ?>
    <script>
        ...
        editamodal.addEventListener('shown.bs.modal', event => {
            ...
            let inputMarca = editamodal.querySelector('.modal-body #idgenerojuego')
            let estadoMarca = editamodal.querySelector('.modal-body #estadogenero')

            let url = "../options_genero/getgenero.php"
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    inputId.value = data.idGeneroJuego
                    inputMarca.value = data.idGeneroJuego
                    estadoMarca.value = data.estadoGeneroJuego
