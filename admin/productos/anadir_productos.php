                    ...
                    <div class="visuals">
                        <div class="image-placeholder-left" style="height: 400px;">
                            <div class="img-left">
                                ...
                                <input required class="file-input" type="file" id="banner" name="banner"
                                    style="width: 130px;">
                            </div>
                            <div class="img-left">
                                <label for="name">visual1:</label>
                                <input required class="file-input" type="file" id="visual1" name="visual1"
                                    style="width: 130px;">
                            </div>
                            <div class="img-left">
                                <label for="name">visual2:</label>
                                <input required class="file-input" type="file" id="visual2" name="visual2"
                                    style="width: 130px;">
                            </div>

                            <div class="img-left">
                                <label for="name">visual3:</label>
                                <input required class="file-input" type="file" id="visual3" name="visual3"
                                    style="width: 130px;">
                            </div>

                            <div class="img-left">
                                <label for="name">trailer:</label>
                                <input required class="file-input" type="file" id="trailer" name="trailer"
                                    style="width: 130px;">
                            </div>
                        </div>
                        <div class="image-placeholder">
                            <label for="name">Portada</label>
                            <input required class="file-input" type="file" id="portada" name="portada"
                                style="width: 130px;">
                        </div>
                    </div>
