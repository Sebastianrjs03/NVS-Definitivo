...
$sql = $con->prepare("SELECT * FROM lenguaje");
$sql->execute();
    ...
    <div class="container1">
        ...
        <main class="main-content1">
            ...
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    <?php include '../options_lenguaje/examplemodal.php'; ?>
                    <?php foreach ($resultado as $row) { ?>
                        <tr>
                            <th scope="row"><?php echo $row['idLenguaje']; ?></th>
                            <td><?php echo $row['estadoLenguaje']; ?></td>

                            <td>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id="<?= $row['idLenguaje'] ?>"><i class="fa-solid fa-pen"></i></button>
                            </td>
                            <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="<?= $row['idLenguaje'] ?>"><i class="fa-solid fa-trash"></i></button></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
            ...
            <section>
                <button type="button"
                    ...
                    <i class="fa-solid fa-plus"></i> Nuevo Lenguaje
                </button>
                <?php include '../options_lenguaje/modalInsert.php'; ?>


            </section>
    </div>

    <?php include '../options_lenguaje/modaldelete.php'; ?>
    <script>
        ...
        editamodal.addEventListener('shown.bs.modal', event => {
            ...
            let inputMarca = editamodal.querySelector('.modal-body #idlenguaje')
            let estadoMarca = editamodal.querySelector('.modal-body #estadolenguaje')

            let url = "../options_lenguaje/getlenguaje.php"
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    inputId.value = data.idLenguaje
                    inputMarca.value = data.idLenguaje
                    estadoMarca.value = data.estadoLenguaje
