...
$sql = $con->prepare("SELECT * FROM direccion");
$sql->execute();
    ...
    <div class="sidebar">
        ...
        <div class="table-responsive">   
            <table class="table table-striped table-dark">
                ...
                <tbody>
                <?php include '../options_direccion/modalUsuario.php'; ?>
                    <?php foreach ($resultado as $row) { ?>
                        <tr>
                            <th scope="row"><?php echo $row['fk_pk_Cliente']; ?></th>
                            <td><?= $row['direccion']; ?></td>
                            <td><?= $row['complemento']; ?></td>

                            <td>
                                <button type="button"
                                    class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id="<?= $row['fk_pk_Cliente']?>">
                                    <i class="fa-solid fa-pen"></i>
                                </button>
                            </td>
                            <td><button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="<?= $row['fk_pk_Cliente']?>"><i class="fa-solid fa-trash"></i></button></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
            ...
            <section>
                <button type="button"
                    ...
                    <i class="fa-solid fa-plus"></i> Nueva Direccion
                </button>
                <?php include '../options_direccion/modalinsert.php'; ?>
            </section>
    </div>

    <?php include '../options_direccion/modaldelete.php'; ?>
    <script>
        ...
        editamodal.addEventListener('shown.bs.modal', event => {
            ...
            let inputcomplemento = editamodal.querySelector('.modal-body #complemento')

            let url = "../options_direccion/getusuario.php"
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    inputid.value = data.fk_pk_Cliente
